...
lrtest(MAPA_sla_lag2,MAPA_sla_lag2a) #3-way interaction strong evidence
...
lrtest(MAPA_fl_lag1,MAPA_fl_lag1a) #3-way interaction very strong evidence

#fl lag0,1
MAPA_fl_lag01a <- lmer(Experiment_Date ~  Drought+MAPA_lag01 + (1|Family) + (1|Block) + (1|Year) + (1|Site_Lat), data=north)
lrtest(MAPA_fl_lag01,MAPA_fl_lag01a) #3-way interaction very strong evidence
