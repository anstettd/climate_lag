...
##########################################################################################################
#Filter datasets
env_1013 <- env_lag0 %>% filter(Year %in% (2010:2013))
env_1114 <- env_lag0 %>% filter(Year %in% (2011:2014))
env_1215 <- env_lag0 %>% filter(Year %in% (2012:2015))
env_1316 <- env_lag0 %>% filter(Year %in% (2013:2016))
env_1013 <- env_lag0 %>% filter(Year %in% (2010:2013))

y9_1013 <- y9 %>% filter(Year %in% (2010:2013))
y9_1114 <- y9 %>% filter(Year %in% (2011:2014))
y9_1215 <- y9 %>% filter(Year %in% (2012:2015))
y9_1316 <- y9 %>% filter(Year %in% (2013:2016))
...
env_1013 <- env_1013 %>% filter(Site!=2 & Site!=4 & Site!=5 & Site!=8 & Site!=10 & Site!=11)
